...
| --- | --- | --- | --- |
| **String toString()** | O(n) | Returns a level-order traversal of the heap. Nodes are separated by level. | <ul><li> Applies to both Min and Max heaps </li></ul> |
| **boolean isEmpty()** | O(1) | Returns true if no meaningful elements in heap, false otherwise (e.g. is ArrayList size == 0 ?) | <ul><li> Applies to both Min and Max heaps </li></ul> |
